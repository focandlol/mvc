...
public class ValidationItemControllerV3 {
   ...
   public String addItem(@Validated @ModelAttribute Item item, BindingResult bindingResult,
     ...
     * @Validate(SaveCheck.class) item class에서 SaveCheck.class 적용된 필드만 validate 적용
     * 실무에서는 잘 사용하지 않음
     */
    @PostMapping("/add")
    ...
    /**
     * Validation groups 적용
     * @Validate(UpdateCheck.class) item class에서 UpdateCheck.class 적용된 필드만 validate 적용
     */
    @PostMapping("/{itemId}/edit")
